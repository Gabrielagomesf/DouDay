...
mixin _$NoteModel {
 ...
 String get id; String get title; String get content; String get category; bool get isPinned; DateTime? get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
 String id, String title, String content, String category, bool isPinned, DateTime? createdAt, DateTime? updatedAt
});
...
/// Create a copy of NoteModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? content = null,Object? category = null,Object? isPinned = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String title,  String content,  String category,  bool isPinned,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String title,  String content,  String category,  bool isPinned,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _NoteModel():
return $default(_that.id,_that.title,_that.content,_that.category,_that.isPinned,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String title,  String content,  String category,  bool isPinned,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _NoteModel() when $default != null:
return $default(_that.id,_that.title,_that.content,_that.category,_that.isPinned,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _NoteModel implements NoteModel {
  const _NoteModel({required this.id, required this.title, this.content = '', this.category = 'general', this.isPinned = false, this.createdAt, this.updatedAt});
...
/// Create a copy of NoteModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? content = null,Object? category = null,Object? isPinned = null,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
